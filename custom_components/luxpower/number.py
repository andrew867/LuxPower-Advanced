...
async def async_setup_entry(hass, config_entry: ConfigEntry, async_add_devices):
    ...
    numbers = [
        ...
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} System Charge Power Rate(%)", "register_address": 64, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_charge", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} System Discharge Power Rate(%)", "register_address": 65, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_discharge", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} AC Charge Power Rate(%)", "register_address": 66, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_charge", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} AC Battery Charge Level", "register_address": 67, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "soc", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Priority Charge Rate(%)", "register_address": 74, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_charge", "enabled": True},
        
        # AFCI Arc Detection Controls
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} AFCI Arc Threshold", "register_address": 180, "def_val": 0, "min_val": 0, "max_val": 65535, "icon": "mdi:flash-alert", "attribute": "afci_curr_ch1", "enabled": True},
        ...
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} System Configuration 12K", "register_address": 178, "def_val": 0, "min_val": 0, "max_val": 65535, "icon": "mdi:cog", "attribute": "sys_config_12k", "enabled": True},
