...
from .helpers import Event, get_comprehensive_device_info, get_device_group_info, get_entity_device_group, should_create_entity_for_model
...
async def async_setup_entry(hass, config_entry: ConfigEntry, async_add_devices):
    ...
    numbers = [
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Grid Volt Connect Low", "register_address": 25, "def_val": 42.0, "min_val": minnumb, "max_val": maxnumb, "step": 0.1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "icon": "mdi:car-turbocharger", "attribute": "v_ac_r", "disabled": False},
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Grid Volt Connect High", "register_address": 26, "def_val": 42.0, "min_val": minnumb, "max_val": maxnumb, "step": 0.1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "icon": "mdi:car-turbocharger", "attribute": "v_ac_r", "disabled": False},
        {"etype": "LNNE", "name": "Lux {replaceID_midfix}{hyphen} Grid Freq Connect Low", "register_address": 27, "divisor": 100, "def_val": 42.0, "min_val": minnumb, "max_val": maxnumb, "step": 0.1, "icon": "mdi:car-turbocharger", "attribute": "f_ac", "disabled": False},
        {"etype": "LNNE", "name": "Lux {replaceID_midfix}{hyphen} Grid Freq Connect High", "register_address": 28, "divisor": 100, "def_val": 42.0, "min_val": minnumb, "max_val": maxnumb, "step": 0.1, "icon": "mdi:car-turbocharger", "attribute": "f_ac", "disabled": False},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} System Charge Power Rate(%)", "unique": "lux_system_charge_power_rate", "register_address": 64, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_charge", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} System Discharge Power Rate(%)", "unique": "lux_system_discharge_power_rate", "register_address": 65, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_discharge", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} AC Charge Power Rate(%)", "unique": "lux_ac_charge_power_rate", "register_address": 66, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_charge", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} AC Battery Charge Level", "unique": "lux_ac_battery_charge_level", "register_address": 67, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "soc", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Priority Charge Rate(%)", "unique": "lux_priority_charge_rate", "register_address": 74, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "attribute": "p_charge", "enabled": True},
        
        # AFCI Arc Detection Controls
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} AFCI Arc Threshold", "unique": "lux_afci_arc_threshold", "register_address": 180, "def_val": 0, "min_val": 0, "max_val": 65535, "icon": "mdi:flash-alert", "attribute": "afci_curr_ch1", "enabled": True},
        
        # Generator Control Number Entities
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Generator Rated Power", "unique": "lux_generator_rated_power", "register_address": 177, "def_val": 0, "min_val": 0, "max_val": 50000, "icon": "mdi:engine", "attribute": "gen_rated_power", "enabled": True},
        ...
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Forced Discharge Power Rate(%)", "unique": "lux_forced_discharge_power_rate", "register_address": 82, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "enabled": True},
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Forced Discharge Battery Level(%)", "unique": "lux_forced_discharge_battery_level", "register_address": 83, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:car-turbocharger", "enabled": True},
        ...
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} AC Charge End Battery SOC(%)", "register_address": 161, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:battery-charging-100", "enabled": False},  # Updated description per 2025.03.05 protocol
        ...
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Grid Peak-Shaving Power", "unique": "lux_grid_peak_shaving_power", "register_address": 206, "def_val": 42.0, "min_val": 0, "max_val": 25.5, "step": 0.1, "mode": NumberMode.BOX, "device_class": NumberDeviceClass.POWER, "unit_of_measurement": UnitOfPower.KILO_WATT, "enabled": True},  # Updated range: 0-255 (0.1kW) per 2025.03.05 protocol
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Start Peak-Shaving SOC 1(%)", "unique": "lux_start_peak_shaving_soc_1", "register_address": 207, "def_val": 42.0, "min_val": minnumb, "max_val": maxperc, "icon": "mdi:battery-80", "enabled": False},
        ...
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Generator Start SOC(%)", "unique": "lux_generator_start_soc", "register_address": -1, "def_val": 20.0, "min_val": 0, "max_val": 100, "icon": "mdi:battery-arrow-up", "enabled": False, "unsupported": True},  # Generator start SOC threshold - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Generator Stop SOC(%)", "unique": "lux_generator_stop_soc", "register_address": -1, "def_val": 80.0, "min_val": 0, "max_val": 100, "icon": "mdi:battery-arrow-down", "enabled": False, "unsupported": True},  # Generator stop SOC threshold - UNKNOWN REGISTER
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Generator Start Voltage", "unique": "lux_generator_start_voltage", "register_address": -1, "def_val": 46.0, "min_val": 40.0, "max_val": 60.0, "step": 0.1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "enabled": False, "unsupported": True},  # Generator start voltage threshold - UNKNOWN REGISTER
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Generator Stop Voltage", "unique": "lux_generator_stop_voltage", "register_address": -1, "def_val": 54.0, "min_val": 40.0, "max_val": 60.0, "step": 0.1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "enabled": False, "unsupported": True},  # Generator stop voltage threshold - UNKNOWN REGISTER
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Generator Charge Current Limit", "unique": "lux_generator_charge_current_limit", "register_address": -1, "def_val": 20.0, "min_val": 0, "max_val": 100.0, "step": 0.1, "device_class": NumberDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE, "enabled": False, "unsupported": True},  # Generator charge current limit - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Generator Cooldown Time (min)", "unique": "lux_generator_cooldown_time", "register_address": -1, "def_val": 30.0, "min_val": 0, "max_val": 240, "icon": "mdi:timer", "enabled": False, "unsupported": True},  # Generator cooldown time in minutes - UNKNOWN REGISTER

        # Battery Management Number Entities (Phase 6) - UNSUPPORTED/UNKNOWN REGISTERS
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Over Temp Protection Threshold", "unique": "lux_over_temp_protection_threshold", "register_address": -1, "def_val": 45.0, "min_val": 30.0, "max_val": 60.0, "step": 0.1, "device_class": NumberDeviceClass.TEMPERATURE, "unit_of_measurement": UnitOfTemperature.CELSIUS, "enabled": False, "unsupported": True},  # Over-temperature protection threshold - UNKNOWN REGISTER
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Under Temp Lockout Threshold", "unique": "lux_under_temp_lockout_threshold", "register_address": -1, "def_val": 0.0, "min_val": -20.0, "max_val": 20.0, "step": 0.1, "device_class": NumberDeviceClass.TEMPERATURE, "unit_of_measurement": UnitOfTemperature.CELSIUS, "enabled": False, "unsupported": True},  # Under-temperature lockout threshold - UNKNOWN REGISTER
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Cell Imbalance Threshold", "unique": "lux_cell_imbalance_threshold", "register_address": -1, "def_val": 0.1, "min_val": 0.01, "max_val": 1.0, "step": 0.01, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "enabled": False, "unsupported": True},  # Cell imbalance threshold - UNKNOWN REGISTER
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Equalization Voltage", "unique": "lux_equalization_voltage", "register_address": -1, "def_val": 58.4, "min_val": 50.0, "max_val": 60.0, "step": 0.1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "enabled": False, "unsupported": True},  # Equalization voltage - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Equalization Time (hours)", "unique": "lux_equalization_time", "register_address": -1, "def_val": 2.0, "min_val": 0.5, "max_val": 8.0, "step": 0.5, "icon": "mdi:timer", "enabled": False, "unsupported": True},  # Equalization time in hours - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Temperature Compensation Factor", "unique": "lux_temperature_compensation_factor", "register_address": -1, "def_val": 0.003, "min_val": 0.0, "max_val": 0.01, "step": 0.001, "icon": "mdi:thermometer", "enabled": False, "unsupported": True},  # Temperature compensation factor - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Aging Compensation Factor", "unique": "lux_aging_compensation_factor", "register_address": -1, "def_val": 1.0, "min_val": 0.5, "max_val": 2.0, "step": 0.1, "icon": "mdi:clock", "enabled": False, "unsupported": True},  # Aging compensation factor - UNKNOWN REGISTER

        # Grid Management Number Entities (Phase 7) - UNSUPPORTED/UNKNOWN REGISTERS
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Grid Import Limit", "unique": "lux_grid_import_limit", "register_address": -1, "def_val": 50.0, "min_val": 0, "max_val": 100.0, "step": 0.1, "device_class": NumberDeviceClass.POWER, "unit_of_measurement": UnitOfPower.KILO_WATT, "enabled": False, "unsupported": True},  # Grid import power limit - UNKNOWN REGISTER
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Grid Export Limit", "unique": "lux_grid_export_limit", "register_address": -1, "def_val": 50.0, "min_val": 0, "max_val": 100.0, "step": 0.1, "device_class": NumberDeviceClass.POWER, "unit_of_measurement": UnitOfPower.KILO_WATT, "enabled": False, "unsupported": True},  # Grid export power limit - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Power Factor Setpoint", "unique": "lux_power_factor_setpoint", "register_address": -1, "def_val": 1.0, "min_val": 0.8, "max_val": 1.0, "step": 0.01, "icon": "mdi:sine-wave", "enabled": False, "unsupported": True},  # Power factor setpoint - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Anti Islanding Sensitivity", "unique": "lux_anti_islanding_sensitivity", "register_address": -1, "def_val": 5.0, "min_val": 1.0, "max_val": 10.0, "step": 0.1, "icon": "mdi:shield", "enabled": False, "unsupported": True},  # Anti-islanding sensitivity - UNKNOWN REGISTER
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Grid Reconnection Delay (s)", "unique": "lux_grid_reconnection_delay", "register_address": -1, "def_val": 60.0, "min_val": 10.0, "max_val": 300.0, "step": 5.0, "icon": "mdi:timer", "enabled": False, "unsupported": True},  # Grid reconnection delay in seconds - UNKNOWN REGISTER
        ...
        # NEW 2025.03.05 Protocol: Battery Hysteresis Controls
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Battery SOC Hysteresis", "register_address": 253, "def_val": 5, "min_val": 5, "max_val": 80, "step": 1, "device_class": NumberDeviceClass.BATTERY, "unit_of_measurement": PERCENTAGE, "icon": "mdi:battery-sync", "enabled": False},  # DeltaSOC (5-80%)
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Battery Voltage Hysteresis", "register_address": 254, "def_val": 2.0, "min_val": 2.0, "max_val": 10.0, "step": 0.1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "icon": "mdi:lightning-bolt", "enabled": False},  # DeltaVolt (2.0-10.0V)
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} BUS Overvoltage Alarm", "register_address": 260, "def_val": 580, "min_val": 550, "max_val": 595, "step": 1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "icon": "mdi:alert-circle", "enabled": False},  # BUS overvoltage alarm (550-595V)
        
        # NEW 2025.03.05 Protocol: Discharge Recovery Threshold (Hold 261)
        # This register contains both SOC and Voltage thresholds in a single register
        # We'll create two separate entities for better user experience
        {"etype": "LPNE", "name": "Lux {replaceID_midfix}{hyphen} Discharge Recovery SOC Threshold", "register_address": 261, "def_val": 20, "min_val": 10, "max_val": 50, "step": 1, "device_class": NumberDeviceClass.BATTERY, "unit_of_measurement": PERCENTAGE, "icon": "mdi:battery-arrow-up", "enabled": False},  # bDisRecovSocThresh (10-50%)
        {"etype": "LDTE", "name": "Lux {replaceID_midfix}{hyphen} Discharge Recovery Voltage Threshold", "register_address": 261, "def_val": 48.0, "min_val": 44.0, "max_val": 52.0, "step": 0.1, "device_class": NumberDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT, "icon": "mdi:lightning-bolt", "enabled": False},  # bDisRecovVoltThresh (44.0-52.0V)
    ]
