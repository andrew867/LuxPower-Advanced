...
public enum CHART_COLOR {
    STANDARD { // from class: com.nfcx.eg4.global.bean.user.CHART_COLOR.1
        @Override // com.nfcx.eg4.global.bean.user.CHART_COLOR
    ...
    DARK { // from class: com.nfcx.eg4.global.bean.user.CHART_COLOR.2
        @Override // com.nfcx.eg4.global.bean.user.CHART_COLOR
        public JSONObject getChartColors() throws JSONException {
            JSONObject jSONObject = new JSONObject();
    ...
    LIGHT { // from class: com.nfcx.eg4.global.bean.user.CHART_COLOR.3
        @Override // com.nfcx.eg4.global.bean.user.CHART_COLOR
        public JSONObject getChartColors() throws JSONException {
            JSONObject jSONObject = new JSONObject();
