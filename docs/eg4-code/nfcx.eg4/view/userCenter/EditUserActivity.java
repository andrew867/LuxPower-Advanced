...
public class EditUserActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        instance = this;
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.userCenter.EditUserActivity.1
        ...
        System.out.println("Eg4CurrentContinentIndex = " + userData.getCurrentContinentIndex());
        ...
        System.out.println("Eg4CurrentRegionIndex = " + currentRegionIndex);
        this.regionSpinner.invalidate();
        this.continentSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.userCenter.EditUserActivity.2
        ...
        System.out.println("Eg4CurrentCountryIndex = " + currentCountryIndex);
        this.countrySpinner.invalidate();
        this.regionSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.userCenter.EditUserActivity.3
            @Override // android.widget.AdapterView.OnItemSelectedListener
            public void onNothingSelected(AdapterView<?> adapterView) {
            }
                ...
                try {
                    if (jSONObject != null) {
                        if (jSONObject.getBoolean("success")) {
                            ...
                            builder.setTitle(R.string.phrase_message).setIcon(android.R.drawable.ic_dialog_info).setMessage(R.string.page_edit_user_success).setNegativeButton(R.string.phrase_button_ok, new DialogInterface.OnClickListener() { // from class: com.nfcx.eg4.view.userCenter.EditUserActivity.EditUserTask.1
