package com.nfcx.eg4.view.register;
...
public class RegisterActivity extends Activity {
    ...
    ArrayAdapter<Property> continentSpinnerAdapter;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        instance = this;
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.register.RegisterActivity.1
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(instance, android.R.layout.simple_spinner_item, GlobalInfo.getInstance().getFirstClusterServerIds());
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.register.RegisterActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m597lambda$onCreate$0$comnfcxeg4viewregisterRegisterActivity(imageView, view);
            }
        });
        ...
        this.continentSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.register.RegisterActivity.2
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.register.RegisterActivity.3
            @Override // android.widget.AdapterView.OnItemSelectedListener
            public void onNothingSelected(AdapterView<?> adapterView) {
            }
        ...
        ((ImageView) findViewById(R.id.register_customerCodescanImageView)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.register.RegisterActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        ((ImageView) findViewById(R.id.scanImageView)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.register.RegisterActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    /* renamed from: lambda$onCreate$0$com-nfcx-eg4-view-register-RegisterActivity, reason: not valid java name */
    /* synthetic */ void m597lambda$onCreate$0$comnfcxeg4viewregisterRegisterActivity(ImageView imageView, View view) {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) throws JSONException {
        ...
        System.out.println("result =111= " + activityResult);
                    ...
                    if (jSONObject.has("continent")) {
                        ...
                        while (true) {
                            ...
                            if (item != null && item.getName().equals(string)) {
                                System.out.println("Eg4 - continentSpinner select: " + i3);
                                break;
                            }
                            i3++;
                        }
    ...
    public void clickRegisterButton(View view) {
        String strValueOf = String.valueOf(100L);
    ...
    private static class RegisterTask extends AsyncTask<Map<String, String>, Object, JSONObject> {
        ...
        */
        public void onPostExecute(org.json.JSONObject r4) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.register.RegisterActivity.RegisterTask.onPostExecute(org.json.JSONObject):void");
        }
    }
