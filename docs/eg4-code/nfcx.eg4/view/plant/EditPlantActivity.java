...
public class EditPlantActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity$$ExternalSyntheticLambda0
        ...
        toggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity.1
            @Override // android.view.View.OnClickListener
    ...
    private void updateFavoritePlantButtons() {
        new Thread(new Runnable() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() throws JSONException {
                this.f$0.m590xd8212817();
            }
        }).start();
    }

    /* renamed from: lambda$updateFavoritePlantButtons$2$com-nfcx-eg4-view-plant-EditPlantActivity, reason: not valid java name */
    /* synthetic */ void m590xd8212817() throws JSONException {
        HashMap map = new HashMap();
        map.put("plantId", String.valueOf(this.currentPlantId));
        ...
        if (jSONObjectPostJson != null) {
            try {
                if (jSONObjectPostJson.getBoolean("success")) {
                    ...
                    runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m589xf2dfb956(z);
                        }
                    });
                }
            } catch (Exception e) {
    ...
    /* renamed from: lambda$updateFavoritePlantButtons$1$com-nfcx-eg4-view-plant-EditPlantActivity, reason: not valid java name */
    /* synthetic */ void m589xf2dfb956(boolean z) {
        ...
        public void onPostExecute(JSONObject jSONObject) throws JSONException {
            ...
            if (jSONObject != null) {
                try {
                    ...
                    EditPlantActivity.instance.continentSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity.GetPlantInfoTask.1
                    ...
                    EditPlantActivity.instance.regionSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity.GetPlantInfoTask.2
                        @Override // android.widget.AdapterView.OnItemSelectedListener
                        public void onNothingSelected(AdapterView<?> adapterView) {
                        }
    ...
    /* renamed from: com.nfcx.eg4.view.plant.EditPlantActivity$2, reason: invalid class name */
    class AnonymousClass2 implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            new Thread(new Runnable() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity$2$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m592lambda$onClick$1$comnfcxeg4viewplantEditPlantActivity$2();
                }
            }).start();
        }

        /* renamed from: lambda$onClick$1$com-nfcx-eg4-view-plant-EditPlantActivity$2, reason: not valid java name */
        /* synthetic */ void m592lambda$onClick$1$comnfcxeg4viewplantEditPlantActivity$2() {
            HashMap map = new HashMap();
            ...
            EditPlantActivity.this.runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.plant.EditPlantActivity$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m591lambda$onClick$0$comnfcxeg4viewplantEditPlantActivity$2(jSONObjectPostJson);
                }
            });
        }
        ...
        /* renamed from: lambda$onClick$0$com-nfcx-eg4-view-plant-EditPlantActivity$2, reason: not valid java name */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        /* synthetic */ void m591lambda$onClick$0$comnfcxeg4viewplantEditPlantActivity$2(org.json.JSONObject r5) {
            /*
                r4 = this;
                r0 = 1
                if (r5 == 0) goto L36
                ...
                com.nfcx.eg4.view.plant.EditPlantActivity r1 = com.nfcx.eg4.view.plant.EditPlantActivity.this     // Catch: java.lang.Throwable -> L62 java.lang.Exception -> L64
                ...
                com.nfcx.eg4.view.plant.EditPlantActivity$2$1 r2 = new com.nfcx.eg4.view.plant.EditPlantActivity$2$1     // Catch: java.lang.Throwable -> L62 java.lang.Exception -> L64
            ...
            L36:
                ...
                if (r5 == 0) goto L4d
                com.nfcx.eg4.view.plant.EditPlantActivity r5 = com.nfcx.eg4.view.plant.EditPlantActivity.this     // Catch: java.lang.Throwable -> L62 java.lang.Exception -> L64
                r1 = 2131886599(0x7f120207, float:1.9407781E38)
                com.nfcx.eg4.tool.Tool.alert(r5, r1)     // Catch: java.lang.Throwable -> L62 java.lang.Exception -> L64
                goto L55
            L4d:
                com.nfcx.eg4.view.plant.EditPlantActivity r5 = com.nfcx.eg4.view.plant.EditPlantActivity.this     // Catch: java.lang.Throwable -> L62 java.lang.Exception -> L64
                ...
                com.nfcx.eg4.tool.Tool.alert(r5, r1)     // Catch: java.lang.Throwable -> L62 java.lang.Exception -> L64
            L55:
                com.nfcx.eg4.view.plant.EditPlantActivity r5 = com.nfcx.eg4.view.plant.EditPlantActivity.instance
                if (r5 == 0) goto L85
                com.nfcx.eg4.view.plant.EditPlantActivity r5 = com.nfcx.eg4.view.plant.EditPlantActivity.instance
            ...
            L64:
                r5 = move-exception
                com.nfcx.eg4.view.plant.EditPlantActivity r1 = com.nfcx.eg4.view.plant.EditPlantActivity.this     // Catch: java.lang.Throwable -> L62
                r2 = 2131887060(0x7f1203d4, float:1.9408716E38)
                com.nfcx.eg4.tool.Tool.alert(r1, r2)     // Catch: java.lang.Throwable -> L62
            ...
            L7c:
                com.nfcx.eg4.view.plant.EditPlantActivity r5 = com.nfcx.eg4.view.plant.EditPlantActivity.instance
                android.widget.Button r5 = com.nfcx.eg4.view.plant.EditPlantActivity.access$1600(r5)
                r5.setEnabled(r0)
            L85:
                return
            L86:
                com.nfcx.eg4.view.plant.EditPlantActivity r1 = com.nfcx.eg4.view.plant.EditPlantActivity.instance
                if (r1 == 0) goto L9b
                com.nfcx.eg4.view.plant.EditPlantActivity r1 = com.nfcx.eg4.view.plant.EditPlantActivity.instance
                boolean r1 = r1.isDestroyed()
                if (r1 != 0) goto L9b
                com.nfcx.eg4.view.plant.EditPlantActivity r1 = com.nfcx.eg4.view.plant.EditPlantActivity.instance
                android.widget.Button r1 = com.nfcx.eg4.view.plant.EditPlantActivity.access$1600(r1)
                r1.setEnabled(r0)
            L9b:
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.plant.EditPlantActivity.AnonymousClass2.m591lambda$onClick$0$comnfcxeg4viewplantEditPlantActivity$2(org.json.JSONObject):void");
        }
    }
}