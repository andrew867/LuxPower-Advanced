...
public class DownloadFirmwareActivity_Backup extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup.1
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup.2
    ...
    */
    public static java.util.List<com.nfcx.eg4.view.updateFirmware.bean.UpdateFileCache> restoreUpdateFileCachesFromLocal(java.io.File r7) throws java.io.IOException {
        /*
        ...
        Lb:
            ...
            com.nfcx.eg4.view.updateFirmware.bean.UpdateFileCache r6 = (com.nfcx.eg4.view.updateFirmware.bean.UpdateFileCache) r6     // Catch: java.lang.Exception -> L2a
        ...
        L3d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup.restoreUpdateFileCachesFromLocal(java.io.File):java.util.List");
    }

    private JSONObject loadRemoteFilesByType(FIRMWARE_DEVICE_TYPE firmware_device_type) {
        updateFileProperties.clear();
        HashMap map = new HashMap();
        map.put("firmwareDeviceType", firmware_device_type.toString());
        return HttpTool.postJson(GlobalInfo.getInstance().getMajorUrl() + "web/maintain/appLocalUpdate/listForAppByType", map);
    }

    private void loadRemoteFiles() {
        new Thread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m604x2b862508();
            }
        }).start();
    }

    /* renamed from: lambda$loadRemoteFiles$1$com-nfcx-eg4-view-updateFirmware-DownloadFirmwareActivity_Backup, reason: not valid java name */
    /* synthetic */ void m604x2b862508() {
        updateFileProperties.clear();
        ...
        runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() throws JSONException {
                this.f$0.m603xc1569ce9(jSONObjectPostJson);
            }
        });
    }

    /* renamed from: lambda$loadRemoteFiles$0$com-nfcx-eg4-view-updateFirmware-DownloadFirmwareActivity_Backup, reason: not valid java name */
    /* synthetic */ void m603xc1569ce9(JSONObject jSONObject) throws JSONException {
        try {
    ...
    private void loadFirmwareDataPackage(final String str, final int i) {
        new Thread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() throws JSONException, IOException {
                this.f$0.m602xc96b6d96(str, i);
            }
        }).start();
    }

    /* renamed from: lambda$loadFirmwareDataPackage$3$com-nfcx-eg4-view-updateFirmware-DownloadFirmwareActivity_Backup, reason: not valid java name */
    /* synthetic */ void m602xc96b6d96(String str, int i) throws JSONException, IOException {
        try {
            ...
            if (jSONObjectPostJson != null && jSONObjectPostJson.getBoolean("success")) {
                ...
                map2.put(str, updateFileCache);
                this.currentFileCacheUpdate = updateFileCache;
                runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m601x5f3be577();
                    }
                });
            ...
            runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity_Backup.3
                @Override // java.lang.Runnable
                public void run() {
    ...
    /* renamed from: lambda$loadFirmwareDataPackage$2$com-nfcx-eg4-view-updateFirmware-DownloadFirmwareActivity_Backup, reason: not valid java name */
    /* synthetic */ void m601x5f3be577() {
    ...
    public void clickGo2UpdateButton(View view) {
        LocalConnectTool.go2LocalActivity(this, com.nfcx.eg4.global.Constants.TARGET_UPDATE_FIRMWARE, 11, this.go2UpdateButton, this.progressBar);
    }
}