...
import com.nfcx.eg4.view.updateFirmware.adapter.DownloadFirmwareAdapter;
...
public class DownloadFirmwareActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity.1
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity.2
        ...
        for (UpdateFileCache updateFileCache : restoreUpdateFileCachesFromLocal(this.firmwareDir)) {
            System.out.println("Eg4 - localUpdateFileCache = " + updateFileCache);
    ...
    */
    public static java.util.List<com.nfcx.eg4.view.updateFirmware.bean.UpdateFileCache> restoreUpdateFileCachesFromLocal(java.io.File r8) throws java.io.IOException {
        /*
        ...
        L23:
            ...
            com.nfcx.eg4.view.updateFirmware.bean.UpdateFileCache r7 = (com.nfcx.eg4.view.updateFirmware.bean.UpdateFileCache) r7     // Catch: java.lang.Exception -> L41
        ...
        L58:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity.restoreUpdateFileCachesFromLocal(java.io.File):java.util.List");
    }
    ...
    public void loadRemoteFilesByType(final FIRMWARE_DEVICE_TYPE firmware_device_type) {
        new Thread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() throws JSONException {
                this.f$0.m599x217abd69(firmware_device_type);
            }
        }).start();
    }

    /* renamed from: lambda$loadRemoteFilesByType$0$com-nfcx-eg4-view-updateFirmware-DownloadFirmwareActivity, reason: not valid java name */
    /* synthetic */ void m599x217abd69(FIRMWARE_DEVICE_TYPE firmware_device_type) throws JSONException {
        try {
            HashMap map = new HashMap();
            map.put("firmwareDeviceType", firmware_device_type.toString());
            JSONArray jSONArray = HttpTool.postJson(GlobalInfo.getInstance().getMajorUrl() + "web/maintain/appLocalUpdate/listForAppByType", map).getJSONArray("rows");
    ...
    private void refreshFirmwareListViewAtUiThread() {
        runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m600xe22fdfb8();
            }
        });
    }
    ...
    private void loadFirmwareDataPackage(final String str, final int i) {
        new Thread(new Runnable() { // from class: com.nfcx.eg4.view.updateFirmware.DownloadFirmwareActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() throws JSONException, IOException {
                this.f$0.m598x67b4324a(str, i);
            }
        }).start();
    }

    /* renamed from: lambda$loadFirmwareDataPackage$2$com-nfcx-eg4-view-updateFirmware-DownloadFirmwareActivity, reason: not valid java name */
    /* synthetic */ void m598x67b4324a(String str, int i) throws JSONException, IOException {
        try {
