package com.nfcx.eg4.view.updateFirmware.bean;
...
public class StandardUploadCheck {
    ...
    public void fillByInverter(Inverter inverter) {
        ...
        } else if (inverter.isGen3_6K() || inverter.isTrip12K()) {
            setV1(Integer.valueOf(Integer.parseInt(fwCode.substring(7, 9), 16)));
            setV2(Integer.valueOf(Integer.parseInt(fwCode.substring(5, 7), 16)));
        } else {
