...
public class LocalOffGridSetFragment extends AbstractItemFragment {
    ...
    public LocalOffGridSetFragment(LocalConnect localConnect) {
        ...
        this._110Functions = new String[]{"FUNC_PV_GRID_OFF_EN", "FUNC_RUN_WITHOUT_GRID", "FUNC_MICRO_GRID_EN", "FUNC_BAT_SHARED", "FUNC_BUZZER_EN", "FUNC_TAKE_LOAD_TOGETHER", "FUNC_GREEN_EN", "FUNC_BATTERY_ECO_EN"};
        this.localConnect = localConnect;
    }

    @Override // androidx.fragment.app.Fragment
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_local_off_grid_set, viewGroup, false);
        ((ConstraintLayout) viewInflate.findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.1
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ...
                if (inverter != null) {
                    ...
                    new ReadMultiParamTask(LocalOffGridSetFragment.this).execute(new RemoteReadInfo(inverter.getSerialNum(), 0, 40), new RemoteReadInfo(inverter.getSerialNum(), 40, 40), new RemoteReadInfo(inverter.getSerialNum(), 80, 40), new RemoteReadInfo(inverter.getSerialNum(), 120, 40), new RemoteReadInfo(inverter.getSerialNum(), CipherSuite.TLS_DH_RSA_WITH_AES_128_GCM_SHA256, 20));
        ...
        editText.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                String string = LocalOffGridSetFragment.this.timeDateEditText.getText().toString();
        ...
        editText2.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                String string = LocalOffGridSetFragment.this.timeTimeEditText.getText().toString();
        ...
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button3 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_pvInputModeButton);
        this.pvInputModeButton = button3;
        button3.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button4 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_batteryCapacityButton);
        this.batteryCapacityButton = button4;
        button4.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        toggleButton2.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        toggleButton3.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.10
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        toggleButton4.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.11
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
                localOffGridSetFragment.runControlRemoteWrite("FUNC_BATTERY_ECO_EN", localOffGridSetFragment.batteryEcoFunctionButton);
            }
        });
        ...
        Button button5 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_epsVoltageSetButton);
        this.epsVoltageSetButton = button5;
        button5.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.12
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button6 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_epsFrequencySetButton);
        this.epsFrequencySetButton = button6;
        button6.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.13
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button7 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_lineModeInputButton);
        this.lineModeInputButton = button7;
        button7.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.14
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button8 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_maxGeneratorInputPowerButton);
        this.maxGeneratorInputPowerButton = button8;
        button8.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.15
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button9 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acFirstStartTimeButton);
        this.acFirstStartTimeButton = button9;
        button9.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.16
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button10 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acFirstEndTimeButton);
        this.acFirstEndTimeButton = button10;
        button10.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.17
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button11 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acFirstStartTime1Button);
        this.acFirstStartTime1Button = button11;
        button11.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.18
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button12 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acFirstEndTime1Button);
        this.acFirstEndTime1Button = button12;
        button12.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.19
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button13 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acFirstStartTime2Button);
        this.acFirstStartTime2Button = button13;
        button13.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.20
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button14 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acFirstEndTime2Button);
        this.acFirstEndTime2Button = button14;
        button14.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.21
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        toggleButton5.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.22
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button15 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_masterOrSlaveButton);
        this.masterOrSlaveButton = button15;
        button15.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.23
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button16 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_composedPhaseButton);
        this.composedPhaseButton = button16;
        button16.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.24
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button17 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_onGridEodVoltageButton);
        this.onGridEodVoltageButton = button17;
        button17.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.25
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button18 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_onGridEodSocButton);
        this.onGridEodSocButton = button18;
        button18.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.26
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button19 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_chargeCurrentButton);
        this.chargeCurrentButton = button19;
        button19.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.27
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button20 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_leadAcidChargeVoltRefButton);
        this.leadAcidChargeVoltRefButton = button20;
        button20.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.28
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button21 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_floatingVoltageButton);
        this.floatingVoltageButton = button21;
        button21.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.29
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button22 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_equalizationVoltageButton);
        this.equalizationVoltageButton = button22;
        button22.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.30
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button23 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_equalizationPeriodButton);
        this.equalizationPeriodButton = button23;
        button23.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.31
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button24 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_equalizationTimeButton);
        this.equalizationTimeButton = button24;
        button24.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.32
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        ArrayAdapter arrayAdapter8 = new ArrayAdapter(viewInflate.getContext(), android.R.layout.simple_spinner_item, arrayList8);
        arrayAdapter8.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        this.acChargeTypeSpinner.setAdapter((SpinnerAdapter) arrayAdapter8);
        Button button25 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeTypeButton);
        this.acChargeTypeButton = button25;
        button25.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.33
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button26 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChgBatCurrentButton);
        this.acChgBatCurrentButton = button26;
        button26.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.34
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button27 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeStartTimeButton);
        this.acChargeStartTimeButton = button27;
        button27.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.35
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button28 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeEndTimeButton);
        this.acChargeEndTimeButton = button28;
        button28.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.36
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button29 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeStartTime1Button);
        this.acChargeStartTime1Button = button29;
        button29.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.37
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button30 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeEndTime1Button);
        this.acChargeEndTime1Button = button30;
        button30.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.38
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button31 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeStartTime2Button);
        this.acChargeStartTime2Button = button31;
        button31.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.39
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button32 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeEndTime2Button);
        this.acChargeEndTime2Button = button32;
        button32.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.40
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button33 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeStartBatteryVoltageButton);
        this.acChargeStartBatteryVoltageButton = button33;
        button33.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.41
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button34 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeEndBatteryVoltageButton);
        this.acChargeEndBatteryVoltageButton = button34;
        button34.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.42
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button35 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeStartBatterySocButton);
        this.acChargeStartBatterySocButton = button35;
        button35.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.43
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button36 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_acChargeEndBatterySocButton);
        this.acChargeEndBatterySocButton = button36;
        button36.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.44
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        ArrayAdapter arrayAdapter9 = new ArrayAdapter(viewInflate.getContext(), android.R.layout.simple_spinner_item, arrayList9);
        arrayAdapter9.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        this.disChgControlSpinner.setAdapter((SpinnerAdapter) arrayAdapter9);
        Button button37 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_disChgControlButton);
        this.disChgControlButton = button37;
        button37.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.45
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button38 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_dischgCurrentButton);
        this.dischgCurrentButton = button38;
        button38.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.46
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button39 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_batteryWarningVoltageButton);
        this.batteryWarningVoltageButton = button39;
        button39.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.47
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button40 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_batteryWarningSocButton);
        this.batteryWarningSocButton = button40;
        button40.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.48
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button41 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_leadAcidDischargeCutOffVoltButton);
        this.leadAcidDischargeCutOffVoltButton = button41;
        button41.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.49
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button42 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_socLowLimitEpsDischgButton);
        this.socLowLimitEpsDischgButton = button42;
        button42.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.50
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
        ...
        Button button43 = (Button) viewInflate.findViewById(R.id.fragment_local_set_datalogSnButton);
        this.datalogSnButton = button43;
        button43.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.51
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                String string = LocalOffGridSetFragment.this.datalogSnEditText.getText().toString();
                String string2 = LocalOffGridSetFragment.this.pinEditText.getText().toString();
                ...
                if (PinTool.verifyDatalog(string, string2)) {
                    try {
                        LocalOffGridSetFragment.this.runDatalogParamWrite(1, string.getBytes(LocalizedMessage.DEFAULT_ENCODING), LocalOffGridSetFragment.this.datalogSnButton);
                        return;
        ...
        Button button44 = (Button) viewInflate.findViewById(R.id.fragment_local_set_all2DefaultButton);
        this.all2DefaultButton = button44;
        button44.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.52
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        Button button45 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_readServerIpButton);
        this.readServerIpButton = button45;
        button45.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.53
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment.this.serverIpSpinner.setAdapter((SpinnerAdapter) new ArrayAdapter(LocalOffGridSetFragment.this.getContext(), android.R.layout.simple_spinner_item, new ArrayList()));
                LocalOffGridSetFragment.this.readServerIpButton.setEnabled(false);
                LocalOffGridSetFragment.this.setServerIpButton.setEnabled(false);
                new ReadDatalogParamTask(LocalOffGridSetFragment.this).execute(6);
            }
        });
        Button button46 = (Button) viewInflate.findViewById(R.id.fragment_remote_set_setServerIpButton);
        this.setServerIpButton = button46;
        button46.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.54
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Property property = (Property) LocalOffGridSetFragment.this.serverIpSpinner.getSelectedItem();
                if (property != null) {
                    try {
                        LocalOffGridSetFragment.this.runDatalogParamWrite(6, property.getName().getBytes(LocalizedMessage.DEFAULT_ENCODING), LocalOffGridSetFragment.this.setServerIpButton);
                    } catch (UnsupportedEncodingException e) {
                        e.printStackTrace();
                    }
                }
        ...
        Button button47 = (Button) viewInflate.findViewById(R.id.fragment_local_set_reset2FactoryButton);
        this.reset2FactoryButton = button47;
        button47.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.55
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
                localOffGridSetFragment.runDatalogParamWrite(3, new byte[]{-91}, localOffGridSetFragment.reset2FactoryButton);
            }
        });
        ...
        this.applicationSetActionToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.56
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.applicationSetActionLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.57
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (LocalOffGridSetFragment.this.applicationSetActionToggleButton.isChecked()) {
        ...
        this.chargeSetActionToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.58
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.chargeSetActionLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.59
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (LocalOffGridSetFragment.this.chargeSetActionToggleButton.isChecked()) {
        ...
        this.dischargeSetActionToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.60
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.dischargeSetActionLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.61
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (LocalOffGridSetFragment.this.dischargeSetActionToggleButton.isChecked()) {
        ...
        this.resetSetActionToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.62
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.resetSetActionLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.63
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (LocalOffGridSetFragment.this.resetSetActionToggleButton.isChecked()) {
        ...
        this.wifiModuleSetActionToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.64
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.wifiModuleSetActionLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.65
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (LocalOffGridSetFragment.this.wifiModuleSetActionToggleButton.isChecked()) {
        ...
        Button button48 = (Button) viewInflate.findViewById(R.id.fragment_local_set_updateFirmwareButton);
        this.updateFirmwareButton = button48;
        button48.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m519xe86a0aa1(view);
            }
        });
        this.created = true;
        return viewInflate;
    ...
    /* renamed from: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment$7, reason: invalid class name */
    class AnonymousClass7 implements View.OnClickListener {
        ...
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            boolean zIsChecked = LocalOffGridSetFragment.this.setToStandbyFunctionButton.isChecked();
            AlertDialog.Builder builder = new AlertDialog.Builder(LocalActivity.instance);
            builder.setTitle(zIsChecked ? R.string.phrase_func_param_normaly : R.string.phrase_func_param_standby).setIcon(android.R.drawable.ic_dialog_info).setMessage(LocalOffGridSetFragment.this.getString(zIsChecked ? R.string.phrase_func_text_normal : R.string.phrase_func_text_standby) + " " + ((Object) LocalOffGridSetFragment.this.inverterSnTextView.getText())).setPositiveButton(R.string.phrase_button_ok, new DialogInterface.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment$7$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.m520x90a35905(dialogInterface, i);
                }
            }).setNegativeButton(R.string.phrase_button_cancel, new DialogInterface.OnClickListener() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment$7$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.m521x96a72464(dialogInterface, i);
                }
            });
            builder.show();
        }

        /* renamed from: lambda$onClick$0$com-nfcx-eg4-view-local-fragment-LocalOffGridSetFragment$7, reason: not valid java name */
        /* synthetic */ void m520x90a35905(DialogInterface dialogInterface, int i) {
            LocalOffGridSetFragment localOffGridSetFragment = LocalOffGridSetFragment.this;
            localOffGridSetFragment.runControlRemoteWrite("FUNC_SET_TO_STANDBY", localOffGridSetFragment.setToStandbyFunctionButton);
        }

        /* renamed from: lambda$onClick$1$com-nfcx-eg4-view-local-fragment-LocalOffGridSetFragment$7, reason: not valid java name */
        /* synthetic */ void m521x96a72464(DialogInterface dialogInterface, int i) {
    ...
    /* renamed from: lambda$onCreateView$0$com-nfcx-eg4-view-local-fragment-LocalOffGridSetFragment, reason: not valid java name */
    /* synthetic */ void m519xe86a0aa1(View view) {
    ...
    public void onResume() {
        super.onResume();
        System.out.println("Eg4 - LocalOffGridFragment onResume...");
    ...
    static class ReadDatalogParamTask extends AsyncTask<Integer, JSONObject, Void> {
            ...
            for (Integer num : numArr) {
                ...
                if (!Tool.isEmpty(datalogParam)) {
                    try {
                        ...
                        if (activity != null) {
                            activity.runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment$ReadDatalogParamTask$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.m522x2026e18f();
                                }
                            });
                        }
                    }
                    ...
                    if (activity2 != null) {
                        activity2.runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment$ReadDatalogParamTask$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.m523x274fc3d0();
                            }
                        });
                    }
                }
        ...
        /* renamed from: lambda$doInBackground$0$com-nfcx-eg4-view-local-fragment-LocalOffGridSetFragment$ReadDatalogParamTask, reason: not valid java name */
        /* synthetic */ void m522x2026e18f() {
            this.fragment.readServerIpButton.setEnabled(false);
        }

        /* renamed from: lambda$doInBackground$1$com-nfcx-eg4-view-local-fragment-LocalOffGridSetFragment$ReadDatalogParamTask, reason: not valid java name */
        /* synthetic */ void m523x274fc3d0() {
            this.fragment.readServerIpButton.setEnabled(false);
        }
    ...
    private static class ReadMultiParamTask extends AsyncTask<RemoteReadInfo, JSONObject, Void> {
                    ...
                    if (!Tool.isEmpty(strSendCommand) && strSendCommand.length() > 36) {
                        ...
                        while (i2 < startRegister + pointNumber) {
                            ...
                            if (i2 == 120) {
                                ...
                                jSONObjectCreateSuccessJSONObject.put("BIT_AC_CHARGE_TYPE", (iCount3 >> this.fragment.getBitByBitParam("BIT_AC_CHARGE_TYPE").intValue()) & 7);
                                jSONObjectCreateSuccessJSONObject.put("BIT_DISCHG_CONTROL_TYPE", (iCount3 >> this.fragment.getBitByBitParam("BIT_DISCHG_CONTROL_TYPE").intValue()) & 3);
                                jSONObjectCreateSuccessJSONObject.put("BIT_ON_GRID_EOD_TYPE", (iCount3 >> this.fragment.getBitByBitParam("BIT_ON_GRID_EOD_TYPE").intValue()) & 1);
                            }
                            i2++;
                            pointNumber = i5;
                        }
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        /* JADX WARN: Can't wrap try/catch for region: R(8:(2:336|6)|(119:8|(7:10|11|334|12|13|338|14)(1:17)|18|(3:20|(1:22)(1:(1:24)(1:25))|26)|27|(1:29)|30|(1:32)|33|(1:35)|36|(1:38)|39|(1:41)|42|(3:44|(1:46)(2:47|(1:49)(2:50|(1:52)(2:53|(1:55)(1:56))))|57)|58|(3:60|(1:62)(2:63|(1:65)(1:66))|67)|68|(2:70|(1:75)(1:74))|76|(1:78)|79|350|80|(1:82)|83|344|84|(1:86)|87|332|88|(4:90|91|340|92)(1:96)|97|328|98|(4:100|101|324|102)(1:106)|107|352|108|(4:110|111|326|112)(1:116)|117|356|118|(5:330|120|121|342|122)(1:125)|126|(1:128)|129|(1:131)|132|(1:134)|135|(1:137)|138|(1:140)|141|(1:143)|144|(1:146)|147|(3:149|(1:151)(2:152|(1:154)(2:155|(1:157)(1:158)))|159)|160|(5:162|163|(1:168)(2:346|167)|169|(1:174)(1:173))(1:175)|176|(1:178)|179|(1:181)|182|(1:184)|185|(1:187)|188|(1:190)|191|(1:193)|194|(1:196)|197|(1:199)|200|(2:202|(1:207)(1:206))|208|(1:210)|211|(1:213)|214|(1:216)|217|(1:219)|220|(1:222)|223|(1:225)|226|(1:228)|229|(1:231)|232|(1:234)|235|(1:237)|238|(1:240)|241|(1:243)|244|(1:246)|247|(1:249)|250|(1:252)|253|(1:255)|256|(1:258)|259|(11:269|270|(1:272)|273|(1:275)|276|(1:278)|279|(1:281)|282|(2:284|362)(1:361))(2:261|(14:266|267|348|268|270|(0)|273|(0)|276|(0)|279|(0)|282|(0)(0))(12:265|269|270|(0)|273|(0)|276|(0)|279|(0)|282|(0)(0)))|322)|316|317|354|318|363|322) */
        /* JADX WARN: Code restructure failed: missing block: B:320:0x06e2, code lost:
        ...
        /* JADX WARN: Code restructure failed: missing block: B:321:0x06e3, code lost:
            ...
            r0.printStackTrace();
         */
        /* JADX WARN: Removed duplicated region for block: B:272:0x05ee A[Catch: Exception -> 0x06c8, TryCatch #12 {Exception -> 0x06c8, blocks: (B:268:0x05e1, B:270:0x05e6, B:272:0x05ee, B:273:0x05fd, B:275:0x0605, B:276:0x0614, B:278:0x061c, B:279:0x062b, B:281:0x0633, B:282:0x0642, B:284:0x064a, B:314:0x06ad), top: B:348:0x05e1 }] */
        /* JADX WARN: Removed duplicated region for block: B:275:0x0605 A[Catch: Exception -> 0x06c8, TryCatch #12 {Exception -> 0x06c8, blocks: (B:268:0x05e1, B:270:0x05e6, B:272:0x05ee, B:273:0x05fd, B:275:0x0605, B:276:0x0614, B:278:0x061c, B:279:0x062b, B:281:0x0633, B:282:0x0642, B:284:0x064a, B:314:0x06ad), top: B:348:0x05e1 }] */
        /* JADX WARN: Removed duplicated region for block: B:278:0x061c A[Catch: Exception -> 0x06c8, TryCatch #12 {Exception -> 0x06c8, blocks: (B:268:0x05e1, B:270:0x05e6, B:272:0x05ee, B:273:0x05fd, B:275:0x0605, B:276:0x0614, B:278:0x061c, B:279:0x062b, B:281:0x0633, B:282:0x0642, B:284:0x064a, B:314:0x06ad), top: B:348:0x05e1 }] */
        /* JADX WARN: Removed duplicated region for block: B:281:0x0633 A[Catch: Exception -> 0x06c8, TryCatch #12 {Exception -> 0x06c8, blocks: (B:268:0x05e1, B:270:0x05e6, B:272:0x05ee, B:273:0x05fd, B:275:0x0605, B:276:0x0614, B:278:0x061c, B:279:0x062b, B:281:0x0633, B:282:0x0642, B:284:0x064a, B:314:0x06ad), top: B:348:0x05e1 }] */
        /* JADX WARN: Removed duplicated region for block: B:284:0x064a A[Catch: Exception -> 0x06c8, TryCatch #12 {Exception -> 0x06c8, blocks: (B:268:0x05e1, B:270:0x05e6, B:272:0x05ee, B:273:0x05fd, B:275:0x0605, B:276:0x0614, B:278:0x061c, B:279:0x062b, B:281:0x0633, B:282:0x0642, B:284:0x064a, B:314:0x06ad), top: B:348:0x05e1 }] */
        /* JADX WARN: Removed duplicated region for block: B:361:0x06e6 A[SYNTHETIC] */
        @Override // android.os.AsyncTask
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public void onProgressUpdate(org.json.JSONObject... r26) throws org.json.JSONException, java.lang.NumberFormatException {
            /*
                Method dump skipped, instructions count: 1791
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.ReadMultiParamTask.onProgressUpdate(org.json.JSONObject[]):void");
        }
    ...
    private static class WriteParamTask extends AsyncTask<RemoteWriteInfo, Void, JSONObject> {
        ...
        public JSONObject doInBackground(RemoteWriteInfo... remoteWriteInfoArr) throws NumberFormatException {
            ...
            if (remoteWriteInfo != null && remoteWriteInfo.getRemoteWriteType() != null) {
                ...
                int i = AnonymousClass66.$SwitchMap$com$nfcx$eg4$global$bean$set$REMOTE_WRITE_TYPE[remoteWriteInfo.getRemoteWriteType().ordinal()];
                if (i == 1) {
        ...
        */
        public void onPostExecute(org.json.JSONObject r4) {
            /*
                ...
                if (r1 == 0) goto L1b
                com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment r4 = r3.fragment     // Catch: java.lang.Throwable -> L50 java.lang.Exception -> L52
            ...
            L45:
                com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment r1 = r3.fragment     // Catch: java.lang.Throwable -> L50 java.lang.Exception -> L52
                com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.access$13200(r1, r4)     // Catch: java.lang.Throwable -> L50 java.lang.Exception -> L52
            L4a:
            ...
            L52:
                ...
                com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment r4 = r3.fragment     // Catch: java.lang.Throwable -> L50 java.lang.Exception -> L63
            ...
            L69:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.WriteParamTask.onPostExecute(org.json.JSONObject):void");
        }
    }

    /* renamed from: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment$66, reason: invalid class name */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void toast(org.json.JSONObject r5) throws java.lang.Exception {
        /*
            Method dump skipped, instructions count: 486
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.toast(org.json.JSONObject):void");
    }
    ...
    */
    public java.lang.Integer getBitSizeByBitParam(java.lang.String r7) {
        ...
        L4d:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.getBitSizeByBitParam(java.lang.String):java.lang.Integer");
    }
    ...
    public Integer getStartRegisterByParam(String str) {
        ...
        switch (c) {
            ...
            case '.':
            case 'G':
                return Integer.valueOf(CipherSuite.TLS_DHE_RSA_WITH_SEED_CBC_SHA);
            case '%':
            case '/':
            case 'H':
                return Integer.valueOf(CipherSuite.TLS_RSA_WITH_AES_128_GCM_SHA256);
            case '&':
            case '0':
            case '?':
                return 78;
            ...
            case 'd':
            case 'e':
                return Integer.valueOf(CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA);
            case '+':
                return 82;
            case ',':
                return Integer.valueOf(CipherSuite.TLS_DH_anon_WITH_AES_128_GCM_SHA256);
            case '-':
                return 28;
            case '2':
                return 32;
            ...
            case '9':
                return Integer.valueOf(CipherSuite.TLS_RSA_PSK_WITH_AES_128_CBC_SHA);
            case ':':
            case 'a':
            case 'r':
                return 155;
            ...
            case 'b':
            case 's':
                return Integer.valueOf(CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384);
            case '<':
            case 'L':
            case 't':
                return 71;
            ...
            case ']':
                return 68;
            case 'C':
                return Integer.valueOf(CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA);
            case 'E':
                return 12;
            case 'F':
                return 102;
            case 'K':
                return 65;
            case 'N':
                return Integer.valueOf(CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256);
            case 'O':
                return Integer.valueOf(CipherSuite.TLS_DH_anon_WITH_AES_256_GCM_SHA384);
            case 'P':
                return 161;
            case 'Q':
                return 119;
            case 'R':
                return Integer.valueOf(R.styleable.AppCompatTheme_windowNoTitle);
            case 'S':
            ...
            case 'v':
            case 'w':
                return Integer.valueOf(CipherSuite.TLS_DHE_DSS_WITH_SEED_CBC_SHA);
            case 'o':
                return 164;
            case 'p':
                return 163;
            ...
            case 'z':
                return Integer.valueOf(CipherSuite.TLS_DHE_PSK_WITH_AES_256_CBC_SHA);
            case '{':
                return Integer.valueOf(CipherSuite.TLS_DH_DSS_WITH_AES_256_GCM_SHA384);
            ...
            case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA /* 134 */:
                return Integer.valueOf(CipherSuite.TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA);
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARN: Failed to restore switch over string. Please report as a decompilation issue */
    /* JADX WARN: Removed duplicated region for block: B:470:0x063f A[RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static boolean checkValueValid(java.lang.String r17, int r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.checkValueValid(java.lang.String, int):boolean");
    }
    ...
    */
    public java.lang.Integer getBitByFunction(java.lang.String r14) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nfcx.eg4.view.local.fragment.LocalOffGridSetFragment.getBitByFunction(java.lang.String):java.lang.Integer");
    }
