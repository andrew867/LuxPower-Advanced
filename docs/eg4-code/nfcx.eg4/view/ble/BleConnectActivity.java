...
public class BleConnectActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        instance = this;
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.ble.BleConnectActivity$$ExternalSyntheticLambda0
        ...
        runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.ble.BleConnectActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m500lambda$onCreate$1$comnfcxeg4viewbleBleConnectActivity();
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.nfcx.eg4.view.ble.BleConnectActivity.1
        ...
        this.swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.nfcx.eg4.view.ble.BleConnectActivity.2
    ...
    /* renamed from: lambda$onCreate$1$com-nfcx-eg4-view-ble-BleConnectActivity, reason: not valid java name */
    /* synthetic */ void m500lambda$onCreate$1$comnfcxeg4viewbleBleConnectActivity() {
    ...
    public void scan() {
        ...
        System.out.println("BLE - mScanStartTime = " + this.mScanStartTime);
        System.out.println("Eg4 - Start scan ble");
        bluetoothLeScanner.startScan((List<ScanFilter>) null, new ScanSettings.Builder().setScanMode(2).build(), this.mScanCallback);
        this.mUpdateFuture = this.mThreadPool.submit(new Callable() { // from class: com.nfcx.eg4.view.ble.BleConnectActivity$$ExternalSyntheticLambda2
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m501lambda$scan$2$comnfcxeg4viewbleBleConnectActivity();
            }
        });
    }

    /* renamed from: lambda$scan$2$com-nfcx-eg4-view-ble-BleConnectActivity, reason: not valid java name */
    /* synthetic */ Boolean m501lambda$scan$2$comnfcxeg4viewbleBleConnectActivity() throws Exception {
        ...
        System.out.println("Eg4 - Scan ble thread is interrupted");
        return true;
    }
    ...
    public void stopScan() {
        ...
        System.out.println("Eg4 - Stop scan ble");
    ...
    private void onIntervalScanUpdate(final boolean z) {
        ...
        Collections.sort(arrayList, new Comparator<ScanResult>() { // from class: com.nfcx.eg4.view.ble.BleConnectActivity.3
        ...
        runOnUiThread(new Runnable() { // from class: com.nfcx.eg4.view.ble.BleConnectActivity.4
            @Override // java.lang.Runnable
            public void run() {
                BleConnectActivity.this.mBleList.clear();
