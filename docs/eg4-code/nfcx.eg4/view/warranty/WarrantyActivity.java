package com.nfcx.eg4.view.warranty;
...
public class WarrantyActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        instance = this;
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.warranty.WarrantyActivity.1
        ...
        ((ImageView) findViewById(R.id.scanImageView)).setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.warranty.WarrantyActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.nfcx.eg4.view.warranty.WarrantyActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private static class GetInverterWarrantyInfoTask extends AsyncTask<String, Object, JSONObject> {
        ...
        public JSONObject doInBackground(String... strArr) {
            ...
            map.put("serialNum", String.valueOf(strArr[0]));
