...
public class BcPskSSLServerSocketFactory extends SSLServerSocketFactory {
    ...
    private SSLServerSocket createSSLServerSocket(final TlsServer tlsServer) throws IOException {
        return new SSLServerSocket() { // from class: com.nfcx.eg4.tls.bc.BcPskSSLServerSocketFactory.1
    ...
    private TlsServer createTlsServer() {
        return new PSKTlsServer(this.crypto, this.pskIdentityMgr) { // from class: com.nfcx.eg4.tls.bc.BcPskSSLServerSocketFactory.2
