package com.lux.luxcloud.connect.ble;
...
import com.lux.luxcloud.tcp.CommandSender;
import com.lux.luxcloud.tcp.TcpAnalyzer;
...
public class BluetoothLocalConnect extends AbstractLocalConnect implements CommandSender {
    ...
    public boolean initialize(boolean z) throws InterruptedException {
        ...
        if (z) {
            for (int i = 0; i < 200 && !this.connected; i++) {
                Tool.sleep(100L);
            }
        }
