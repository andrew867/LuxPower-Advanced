...
import com.lux.luxcloud.view.logout.LogoutActivity;
...
public class UserCenterActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) throws JSONException {
        ...
        ((ConstraintLayout) findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.view.userCenter.UserCenterActivity$$ExternalSyntheticLambda0
        ...
        toggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.view.userCenter.UserCenterActivity.1
            @Override // android.view.View.OnClickListener
        ...
        this.deleteUserActionLayout.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.view.userCenter.UserCenterActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (UserCenterActivity.this.deleteUserActionToggleButton.isChecked()) {
    ...
    /* renamed from: com.lux.luxcloud.view.userCenter.UserCenterActivity$3, reason: invalid class name */
    class AnonymousClass3 implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            new Thread(new Runnable() { // from class: com.lux.luxcloud.view.userCenter.UserCenterActivity$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m781x848bda35();
                }
            }).start();
        }

        /* renamed from: lambda$onClick$1$com-lux-luxcloud-view-userCenter-UserCenterActivity$3, reason: not valid java name */
        /* synthetic */ void m781x848bda35() {
            ...
            UserCenterActivity.this.runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.userCenter.UserCenterActivity$3$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m780x5b3784f4(jSONObjectPostJson);
                }
            });
        }
        ...
        /* renamed from: lambda$onClick$0$com-lux-luxcloud-view-userCenter-UserCenterActivity$3, reason: not valid java name */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        /* synthetic */ void m780x5b3784f4(org.json.JSONObject r4) {
            /*
                r3 = this;
                if (r4 == 0) goto L35
                ...
                com.lux.luxcloud.view.userCenter.UserCenterActivity r0 = com.lux.luxcloud.view.userCenter.UserCenterActivity.this     // Catch: java.lang.Exception -> L3e
                ...
                com.lux.luxcloud.view.userCenter.UserCenterActivity$3$1 r1 = new com.lux.luxcloud.view.userCenter.UserCenterActivity$3$1     // Catch: java.lang.Exception -> L3e
                ...
                goto L4a
            L35:
                com.lux.luxcloud.view.userCenter.UserCenterActivity r4 = com.lux.luxcloud.view.userCenter.UserCenterActivity.this     // Catch: java.lang.Exception -> L3e
                r0 = 2131887255(0x7f120497, float:1.9409112E38)
                com.lux.luxcloud.tool.Tool.alert(r4, r0)     // Catch: java.lang.Exception -> L3e
                goto L4a
            L3e:
                r4 = move-exception
                com.lux.luxcloud.view.userCenter.UserCenterActivity r0 = com.lux.luxcloud.view.userCenter.UserCenterActivity.this
                r1 = 2131887253(0x7f120495, float:1.9409108E38)
                com.lux.luxcloud.tool.Tool.alert(r0, r1)
                r4.printStackTrace()
            L4a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.lux.luxcloud.view.userCenter.UserCenterActivity.AnonymousClass3.m780x5b3784f4(org.json.JSONObject):void");
        }
    }
