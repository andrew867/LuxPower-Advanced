package com.lux.luxcloud.view.main.fragment.lv2;
...
import com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment;
...
public class Lv2RemoteSetFragment extends AbstractItemFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        System.out.println("isDarkTheme == " + this.isDarkTheme);
        this.cameraManager = (CameraManager) this.fragment.getActivity().getSystemService("camera");
    ...
    private void InitView(final View view) {
        ...
        ((ConstraintLayout) view.findViewById(R.id.backImageViewLayout)).setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.1
        ...
        ((ImageView) view.findViewById(R.id.userCenterImageView)).setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
        ...
        this.webView.setWebChromeClient(new WebChromeClient() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.3
            ...
            public void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
                if (ContextCompat.checkSelfPermission(Lv2RemoteSetFragment.this.getContext(), "android.permission.ACCESS_FINE_LOCATION") != 0) {
                    ActivityCompat.requestPermissions(Lv2RemoteSetFragment.this.getActivity(), new String[]{"android.permission.ACCESS_FINE_LOCATION"}, Constants.LOCATION_PERMISSION_REQUEST_CODE);
                } else {
        ...
        this.webView.setWebViewClient(new WebViewClient() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.4
        ...
        this.readAllButton.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                this.f$0.m649xa383d0c2(userData, view2);
            }
        });
    }

    /* renamed from: lambda$InitView$1$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment, reason: not valid java name */
    /* synthetic */ void m649xa383d0c2(UserData userData, View view) {
        if (this.inverter != null) {
            ...
            this.webView.setOnTouchListener(new View.OnTouchListener() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda0
            ...
            RemoteReadInfo remoteReadInfo7 = new RemoteReadInfo(this.inverter.getSerialNum(), 160, 40);
        ...
        if (list != null && !list.isEmpty()) {
            for (PARAM param : list) {
                try {
                    ...
                    jSONObject2.put("fwVersion", this.inverter.getFwVersionValue());
                    jSONObject2.put("slaveVersion", this.inverter.getSlaveVersionValue());
        ...
        if (list != null && !list.isEmpty()) {
            for (BattChgPARAM battChgPARAM : list) {
                try {
                    ...
                    jSONObject.put("fwVersion", this.inverter.getFwVersionValue());
                    jSONObject.put("slaveVersion", this.inverter.getSlaveVersionValue());
                    jSONArray.put(jSONObject);
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    static class ReadMultiParamTask extends AsyncTask<RemoteReadInfo, JSONObject, Void> {
        ...
        public Void doInBackground(RemoteReadInfo... remoteReadInfoArr) throws JSONException {
            ...
            for (RemoteReadInfo remoteReadInfo : remoteReadInfoArr) {
                ...
                try {
                    ...
                    resultsList.put("dtc", this.fragment.inverter.getDtcValue());
                ...
                activity.runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$ReadMultiParamTask$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() throws JSONException {
                        this.f$0.m657x273be959(jSONObjectPostJson);
                    }
                });
                return null;
            }
        ...
        /* renamed from: lambda$doInBackground$0$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment$ReadMultiParamTask, reason: not valid java name */
        /* synthetic */ void m657x273be959(JSONObject jSONObject) throws JSONException {
            this.fragment.m654x118ee18c(jSONObject);
        }
        ...
        public void onPostExecute(Void r11) throws JSONException {
            ...
            if (this.hasMasterInverterSn) {
                ...
                this.fragment.webView.setOnTouchListener(new View.OnTouchListener() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$ReadMultiParamTask$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnTouchListener
    ...
    private static class WriteParamTask extends AsyncTask<RemoteWriteInfo, Void, JSONObject> {
        ...
        public JSONObject doInBackground(RemoteWriteInfo... remoteWriteInfoArr) throws JSONException, NumberFormatException {
            ...
            if (remoteWriteInfo != null && remoteWriteInfo.getRemoteWriteType() != null) {
                ...
                System.out.println("remoteWriteInfo.getBitParam() == " + remoteWriteInfo.getBitParam());
                switch (AnonymousClass9.$SwitchMap$com$lux$luxcloud$global$bean$set$REMOTE_WRITE_TYPE[remoteWriteInfo.getRemoteWriteType().ordinal()]) {
                    case 1:
                    ...
                    case 2:
                        String modelText = remoteWriteInfo.getModelText();
                        if (Tool.isEmpty(modelText)) {
                            return this.fragment.createFailureJSONObject("PARAM_EMPTY");
                        }
                        return postwritePartModel(modelText);
                    case 3:
        ...
        private JSONObject postwritePartModel(String str) {
            try {
                return HttpTool.multiPartPostJson(GlobalInfo.getInstance().getBaseUrl() + "web/maintain/remoteSet/writePartModel", str);
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        /* JADX WARN: Removed duplicated region for block: B:62:0x020d A[Catch: all -> 0x0248, Exception -> 0x024a, TryCatch #3 {Exception -> 0x024a, blocks: (B:4:0x000d, B:6:0x0015, B:26:0x0071, B:27:0x0076, B:28:0x0087, B:30:0x0097, B:31:0x009d, B:32:0x00cd, B:34:0x00e1, B:35:0x00e6, B:36:0x00e7, B:37:0x00ec, B:39:0x00fe, B:40:0x0107, B:42:0x011b, B:43:0x0120, B:44:0x0121, B:45:0x0156, B:46:0x0165, B:48:0x0179, B:49:0x017e, B:50:0x017f, B:51:0x01a6, B:52:0x01c7, B:54:0x01da, B:55:0x01df, B:56:0x01e0, B:57:0x01e5, B:58:0x01f4, B:60:0x0207, B:61:0x020c, B:62:0x020d, B:64:0x0211, B:66:0x021f, B:68:0x0227, B:71:0x023a, B:72:0x023d), top: B:91:0x000d, outer: #7 }] */
        @Override // android.os.AsyncTask
        /*
        ...
        */
        public void onPostExecute(org.json.JSONObject r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.WriteParamTask.onPostExecute(org.json.JSONObject):void");
        }
    }

    /* renamed from: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$9, reason: invalid class name */
    static /* synthetic */ class AnonymousClass9 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$lux$luxcloud$global$bean$set$REMOTE_WRITE_TYPE[REMOTE_WRITE_TYPE.PART_MODEL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$lux$luxcloud$global$bean$set$REMOTE_WRITE_TYPE[REMOTE_WRITE_TYPE.BIT_PARAM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$lux$luxcloud$global$bean$set$REMOTE_WRITE_TYPE[REMOTE_WRITE_TYPE.BIT_MODEL_PARAM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$lux$luxcloud$global$bean$set$REMOTE_WRITE_TYPE[REMOTE_WRITE_TYPE.RESET.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$com$lux$luxcloud$global$bean$set$REMOTE_WRITE_TYPE[REMOTE_WRITE_TYPE.TIME.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$com$lux$luxcloud$global$bean$set$REMOTE_WRITE_TYPE[REMOTE_WRITE_TYPE.CONTROL.ordinal()] = 7;
    ...
    private void initInverterSpinnerOnItemSelectedListener() {
        if (this.inverterSpinner.getOnItemSelectedListener() == null) {
            ...
            this.inverterSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.5
    ...
    private class WebAppSysInterface {
        ...
        public void manageFlashLight(boolean z) throws CameraAccessException {
            if (Lv2RemoteSetFragment.this.isFlashAvailable()) {
                Lv2RemoteSetFragment.this.setFlashMode(z);
            }
        }

        @JavascriptInterface
        public void openCamera() {
            new IntentIntegrator(Lv2RemoteSetFragment.this.fragment.getActivity()).setDesiredBarcodeFormats(IntentIntegrator.QR_CODE).setPrompt(Lv2RemoteSetFragment.this.getString(R.string.warranty_scan_tip_text)).setCameraId(0).setBeepEnabled(true).setBarcodeImageEnabled(false).initiateScan();
        }

        @JavascriptInterface
        public void getLocation() {
            Lv2RemoteSetFragment.this.getLastLocation(new LocationCallback() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.WebAppSysInterface.1
                @Override // com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.LocationCallback
                public void onLocationReceived(double d, double d2) {
                    System.out.println("latitude == " + d);
                    System.out.println("longitude == " + d2);
                    Lv2RemoteSetFragment.this.webView.evaluateJavascript("javascript:onLocationReceived(" + d + ", " + d2 + ")", null);
                }
            });
        }
    ...
    private class WebAppInterface {
        ...
        public String getParamVisible(String str, String str2) throws JSONException {
            ...
            List<String> list = (List) new Gson().fromJson(str, new TypeToken<List<String>>() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.WebAppInterface.1
            }.getType());
            ...
            for (String str3 : list) {
                if ("file:///android_asset/module/settingContent/acChargeSetting.html".equals(Lv2RemoteSetFragment.this.currentUrl)) {
                    if ("HOLD_AC_CHARGE_END_BATTERY_VOLTAGE".equals(str3)) {
            ...
            for (int i = 0; i < paramInfos.length(); i++) {
                ...
                if (jSONObject3.has("holdParam") && "HOLD_BACK_UP_END_BATTERY_VOLTAGE".equals(jSONObject3.getString("holdParam"))) {
        ...
        @JavascriptInterface
        public void postWritePartModel(String str) {
            if (Lv2RemoteSetFragment.this.inverter != null) {
                com.alibaba.fastjson2.JSONObject object = com.alibaba.fastjson2.JSONObject.parseObject(str);
                object.put("inverterSn", Lv2RemoteSetFragment.this.inverter.getSerialNum());
                RemoteWriteInfo remoteWriteInfo = new RemoteWriteInfo();
                remoteWriteInfo.setRemoteWriteType(REMOTE_WRITE_TYPE.PART_MODEL);
                remoteWriteInfo.setModelText(object.toJSONString(new JSONWriter.Feature[0]));
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (activityResult != null) {
            if (activityResult.getContents() == null) {
                this.fragment.getActivity().runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.6
                    @Override // java.lang.Runnable
                    public void run() {
                        Toast.makeText(Lv2RemoteSetFragment.this.fragment.getContext(), "Cancelled", 0).show();
                    }
                });
                return;
            } else {
                final String contents = activityResult.getContents();
                this.fragment.getActivity().runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.7
                    @Override // java.lang.Runnable
                    public void run() {
                        Toast.makeText(Lv2RemoteSetFragment.this.fragment.getContext(), contents, 0).show();
                    }
                });
                return;
            }
    ...
    public void getLastLocation(final LocationCallback locationCallback) {
        if (ActivityCompat.checkSelfPermission(getContext(), "android.permission.ACCESS_FINE_LOCATION") == 0 && ActivityCompat.checkSelfPermission(getContext(), "android.permission.ACCESS_COARSE_LOCATION") == 0) {
            this.fusedLocationClient.getLastLocation().addOnSuccessListener(getActivity(), new OnSuccessListener() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda8
                @Override // com.google.android.gms.tasks.OnSuccessListener
                public final void onSuccess(Object obj) {
                    this.f$0.m656x5310ca4f(locationCallback, (Location) obj);
                }
            });
        } else {
            ActivityCompat.requestPermissions(getActivity(), new String[]{"android.permission.ACCESS_FINE_LOCATION"}, Constants.LOCATION_PERMISSION_REQUEST_CODE);
        }
    }

    /* renamed from: lambda$getLastLocation$2$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment, reason: not valid java name */
    /* synthetic */ void m656x5310ca4f(LocationCallback locationCallback, Location location) {
        if (location == null) {
            Toast.makeText(getContext(), "Location not available", 0).show();
    ...
    public String fetchWattNodeResult() throws InterruptedException {
        ...
        new Thread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m655xa5cd512b(atomicReference, countDownLatch);
            }
        }).start();
        try {
    ...
    /* renamed from: lambda$fetchWattNodeResult$4$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment, reason: not valid java name */
    /* synthetic */ void m655xa5cd512b(AtomicReference atomicReference, CountDownLatch countDownLatch) {
        try {
            try {
                HashMap map = new HashMap();
                ...
                if (jSONObjectPostJson.getBoolean("success")) {
                    ...
                    FragmentActivity activity = this.fragment.getActivity();
                    if (activity != null) {
                        activity.runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda6
                            @Override // java.lang.Runnable
                            public final void run() throws JSONException {
                                this.f$0.m654x118ee18c(jSONObjectPostJson);
                            }
                        });
                    }
                }
    ...
    public void WriteWattNode(final HashMap<String, String> map) {
        new Thread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() throws JSONException {
                this.f$0.m653x5f31a41f(map);
            }
        }).start();
    }

    /* renamed from: lambda$WriteWattNode$8$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment, reason: not valid java name */
    /* synthetic */ void m653x5f31a41f(HashMap map) throws JSONException {
        try {
            if (Tool.isEmpty((String) map.get("ctAmpsA")) || Tool.isEmpty((String) map.get("ctAmpsB")) || Tool.isEmpty((String) map.get("ctAmpsC"))) {
                FragmentActivity activity = this.fragment.getActivity();
                if (activity != null) {
                    activity.runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m650xa2765542();
                        }
                    });
                }
            } else {
                ...
                if (jSONObjectPostJson.getBoolean("success")) {
                    this.fragment.getActivity().runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.m651x36b4c4e1();
                        }
                    });
                } else {
                    ...
                    if (activity2 != null) {
                        activity2.runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.8
                            @Override // java.lang.Runnable
                            public void run() {
            ...
            this.fragment.getActivity().runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m652xcaf33480();
                }
            });
            e.printStackTrace();
        }
    ...
    /* renamed from: lambda$WriteWattNode$5$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment, reason: not valid java name */
    /* synthetic */ void m650xa2765542() {
        Tool.alert(getActivity(), R.string.page_maintain_remote_set_alert_param_empty);
    }

    /* renamed from: lambda$WriteWattNode$6$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment, reason: not valid java name */
    /* synthetic */ void m651x36b4c4e1() {
        Tool.alert(getActivity(), R.string.local_set_result_success);
    }

    /* renamed from: lambda$WriteWattNode$7$com-lux-luxcloud-view-main-fragment-lv2-Lv2RemoteSetFragment, reason: not valid java name */
    /* synthetic */ void m652xcaf33480() {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.isDarkTheme = ((UiModeManager) this.fragment.getActivity().getSystemService("uimode")).getNightMode() == 2;
        System.out.println("isDarkTheme updated to: " + this.isDarkTheme);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void m654x118ee18c(org.json.JSONObject r6) throws org.json.JSONException {
        /*
            Method dump skipped, instructions count: 598
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lux.luxcloud.view.main.fragment.lv2.Lv2RemoteSetFragment.m654x118ee18c(org.json.JSONObject):void");
    }
}