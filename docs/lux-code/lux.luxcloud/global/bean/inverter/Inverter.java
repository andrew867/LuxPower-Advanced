...
public class Inverter implements Serializable {
    ...
    public boolean checkSupportQuickDisCharge() {
        return (!isHybird() || isPhase3() || isParallelGroup()) ? false : true;
    }
    ...
    public boolean isGeta() {
        Integer num;
        Integer num2 = this.deviceType;
        return num2 != null && num2.intValue() == 13 && ((num = this.phase) == null || num.intValue() != 3);
    }
    ...
    public boolean isSna6kEneleageZero() {
        return isOffGrid() && isDtcAmerica() && getMachineType() == 5 && getOdmValue().intValue() == 8;
    }
    ...
    public boolean is12KEUVersion() {
        Integer num;
        return isType6() && (num = this.usVersion) != null && num.intValue() == Constants.MODEL_EU_VERSION_US;
    }
    ...
    public Integer getOdmValue() {
        Integer num = this.odm;
        return Integer.valueOf(num == null ? -1 : num.intValue());
    }
    ...
    public void setOdm(Integer num) {
        this.odm = num;
    }
