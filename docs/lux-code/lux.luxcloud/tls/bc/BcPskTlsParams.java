...
public class BcPskTlsParams {
    ...
    private static final Comparator<ProtocolVersion> protocolComparator = new Comparator() { // from class: com.lux.luxcloud.tls.bc.BcPskTlsParams$$ExternalSyntheticLambda0
