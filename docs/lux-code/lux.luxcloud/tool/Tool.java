...
public class Tool {
    private static final SimpleDateFormat registerIdTimeFormat = new SimpleDateFormat("yyyyMMdd'T'HHmmss");
    private static SimpleDateFormat dateTimeFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private static SimpleDateFormat dashDateFormatYMD = new SimpleDateFormat("yyyy-MM-dd");

    public static synchronized Date parseRegisterIdTime(String str) {
        Date date;
        date = null;
        try {
            if (!isEmpty(str)) {
                date = registerIdTimeFormat.parse(str);
            }
    ...
    public static synchronized String formatDate(Date date) {
        return date != null ? dashDateFormatYMD.format(date) : "";
    }
    ...
    public static synchronized Date parseDate(String str) {
        ...
        try {
            if (!isEmpty(str)) {
                date = dashDateFormatYMD.parse(str.replace("_", "-"));
            }
        } catch (ParseException e) {
            e.printStackTrace();
            return null;
    ...
    public static synchronized String formatRegisterIdTime(Date date) {
        return date == null ? "" : registerIdTimeFormat.format(date);
    }
    ...
    public static void alert(Activity activity, SpannableString spannableString) {
        if (activity.isFinishing()) {
            return;
        }
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        builder.setTitle(R.string.phrase_message).setIcon(android.R.drawable.ic_dialog_info).setMessage(spannableString).setNegativeButton(R.string.phrase_button_ok, (DialogInterface.OnClickListener) null);
        builder.show();
    }
    ...
    public static void alert(Activity activity, String str, DialogInterface.OnDismissListener onDismissListener) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        builder.setTitle(R.string.phrase_message).setIcon(android.R.drawable.ic_dialog_info).setMessage(str).setNegativeButton(R.string.phrase_button_ok, new DialogInterface.OnClickListener() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda0
    ...
    public static void alert(Activity activity, String str, String str2, DialogInterface.OnDismissListener onDismissListener) {
        if (activity.isFinishing()) {
            return;
        }
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        ...
        builder.setIcon(android.R.drawable.ic_dialog_info).setNegativeButton(R.string.phrase_button_ok, new DialogInterface.OnClickListener() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda8
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
            }
    ...
    public static void alertDialog(Activity activity, String str, String str2, boolean z, boolean z2, int i, String str3, int i2, String str4, final DialogInterface.OnClickListener onClickListener, final DialogInterface.OnClickListener onClickListener2) {
        ...
        if (z) {
            ...
            textView3.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    Tool.lambda$alertDialog$2(onClickListener, dialog, view);
                }
            });
        } else {
        ...
        if (z2) {
            ...
            textView5.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    Tool.lambda$alertDialog$3(onClickListener2, dialog, view);
                }
            });
        } else {
    ...
    static /* synthetic */ void lambda$alertDialog$3(DialogInterface.OnClickListener onClickListener, Dialog dialog, View view) {
        if (onClickListener != null) {
    ...
    public static void showInputDialog(Activity activity, String str, String str2, String str3, final boolean z, boolean z2, boolean z3, boolean z4, boolean z5, int i, String str4, int i2, String str5, int i3, String str6, final Consumer<String> consumer, final Runnable runnable) {
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Tool.lambda$showInputDialog$4(dialog, runnable, view);
            }
        });
        textView4.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Tool.lambda$showInputDialog$5(dialog, runnable, view);
            }
        });
        textView5.setOnClickListener(new View.OnClickListener() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Tool.lambda$showInputDialog$6(dialog, z, editText, consumer, view);
            }
        });
        Window window = dialog.getWindow();
        if (window != null) {
    ...
    static /* synthetic */ void lambda$showInputDialog$5(Dialog dialog, Runnable runnable, View view) {
        dialog.dismiss();
        if (runnable != null) {
            runnable.run();
        }
    ...
    static /* synthetic */ void lambda$showInputDialog$6(Dialog dialog, boolean z, EditText editText, Consumer consumer, View view) {
        dialog.dismiss();
    ...
    public static int versionToInt(String str) throws NumberFormatException {
        String[] strArrSplit = str.split("\\.");
        return (Integer.parseInt(strArrSplit[0]) * 10000) + ((strArrSplit.length > 1 ? Integer.parseInt(strArrSplit[1]) : 0) * 100) + (strArrSplit.length > 2 ? Integer.parseInt(strArrSplit[2]) : 0);
    }
    ...
    public static void alertNotInUiThread(final Activity activity, final String str) {
        ...
        activity.runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda7
    ...
    public static void alertNotInUiThread(final Activity activity, final int i) {
        ...
        activity.runOnUiThread(new Runnable() { // from class: com.lux.luxcloud.tool.Tool$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public static java.lang.Long getCRC32(java.io.File r9) throws java.lang.Throwable {
        ...
        Ld9:
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lux.luxcloud.tool.Tool.getCRC32(java.io.File):java.lang.Long");
    }
    ...
    public static boolean isAloneClusterGroup() {
        String currentClusterGroup = GlobalInfo.getInstance().getCurrentClusterGroup();
        return Constants.CLUSTER_GROUP_INDIA.equals(currentClusterGroup) || Constants.CLUSTER_GROUP_EU2.equals(currentClusterGroup) || Constants.CLUSTER_GROUP_PHILIPPINES.equals(currentClusterGroup) || Constants.CLUSTER_GROUP_VIETNAM.equals(currentClusterGroup);
    }
    ...
    public static Inverter getInverterByJsonObj(JSONObject jSONObject, Plant plant) throws JSONException {
        ...
        inverter.setOdm(Integer.valueOf(jSONObject.getInt("odm")));
