package com.lux.luxcloud.service;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String str, String str2) {
        ...
        notificationManager.notify(this.requestCode, new NotificationCompat.Builder(this, "my_channel_id").setContentTitle(str).setContentText(str2).setSmallIcon(R.drawable.ic_launcher_backup).setAutoCancel(true).setPriority(1).setDefaults(-1).setSound(Settings.System.DEFAULT_NOTIFICATION_URI, 5).setVibrate(new long[]{1000, 1000, 1000, 1000, 1000}).build());
    }
}